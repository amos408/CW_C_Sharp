...
//statementb more than one line, you need to add { and } at the head and tail of statement in JS, to keep the same indentation 
//on Python and to put a end in Ruby where it indeed ends.
